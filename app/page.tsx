      ...
      <main>
        <header>
          <div className="flex justify-between items-end">
            <div>
              <h2 className="font-bold text-2xl text-gray-900 mb-2 ">Patient List</h2>
              <p className="text-base ">Overview of all registered patients</p>
            </div>
            <button className="px-4 py-2 rounded rounded-full font-medium shadow focus:outline-none focus:ring-2 focus:ring-offset-1 transition-colors bg-[var(--color-btn-primary)] text-[var(--color-btn-primary-text)] hover:bg-[var(--color-btn-primary-hover)] cursor-pointer ">New</button>
          </div>
        </header>
